...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
#if defined(_EMBMEM_SPI_NOR_)
#if (defined(_NVT_ETHREARCAM_TX_)) //4MB spi
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	...
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x002A0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
   	...
   	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x002F0000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
    [5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00370000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	[6] = {EMBTYPE_ECOS,	0,	BLK_UNIT(0x00370000), BLK_UNIT(0x00090000), BLK_UNIT(0x00000000)},
	#else
    [4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x002F0000), BLK_UNIT(0x00110000), BLK_UNIT(0x00000000)},
    [5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00400000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	...
	#endif
	#endif
	[7] = {EMBTYPE_FAT,     0,  BLK_UNIT(0x07140000), BLK_UNIT(0x30000000), BLK_UNIT(0x00000000)},
