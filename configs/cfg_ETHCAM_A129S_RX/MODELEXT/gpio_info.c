...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
    ...
    {  GPIO_WIFI_REG_ON,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST   },
    //LED
    {  GPIO_GREEN_LED,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST   },
    {  GPIO_RED_LED,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST   },
    ...
    {  GPIO_ACC_PLUG,          GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_ACC_PLUG        },
    {  GPIO_4G_WAKEUP,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST   },
#endif
};
