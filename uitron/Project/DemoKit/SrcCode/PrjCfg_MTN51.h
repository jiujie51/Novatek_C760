#ifndef _PRJCFG_MTN51_H_
#define _PRJCFG_MTN51_H_
#include "Type.h"
#include "SysKer.h"
#include "BG_Images.h"
//==============================================================================
...
//..............................................................................
// FW version and name
#define FW_UPDATE_NAME                  "A:\\FW96672N.bin"
#define FW_VERSION_RELEASE              DISABLE //ENABLE
#define FW_VERSION_NUM                  "MTN51-5000-20191209 V1.7"
...
#define USER_DX_TYPE_EMBMEM_USER0        DX_TYPE_EMBMEM9 //STRG_OBJ_FW_RSV5
#define USER_DX_TYPE_EMBMEM_USER1        DX_TYPE_EMBMEM10 //STRG_OBJ_FW_RSV5
...
#define PST_FUNC                        ENABLE//DISABLE  //enable it, if require write pstore

#define USER_PACK_UPDATE_ENABLE		1
...
#define SENSOR_GP_2                     SENSOR_MULTI_ID_2//SENSOR_MULTI_ID_NONE /*ex: SENSOR_MULTI_ID_3|SENSOR_MULTI_ID_4*/
// Sensor sub group

#define SENSOR_SUBGP_1                  SENSOR_MULTI_ID_NONE
#define SENSOR_SUBGP_2                  SENSOR_MULTI_ID_NONE

#define SENSOR_MULTI_ID_1_INPORT        0
#define SENSOR_MULTI_ID_1_OUTPORT       0
#define SENSOR_MULTI_ID_1_SIG           0

#define SENSOR_MULTI_ID_2_INPORT        0
#define SENSOR_MULTI_ID_2_OUTPORT       0
#define SENSOR_MULTI_ID_2_SIG           0

// Sensor Insert Mask
//#define SENSOR_INSERT_MASK              (SENSOR_1) // support insert sensor
//#define SENSOR_INSERT_MASK              (SENSOR_2) // support insert sensor
#define SENSOR_INSERT_MASK              (SENSOR_2)//(0) // if NOT support insert sensor, please choose this
...
#define AUDPROC_FUNC                    DISABLE//ENABLE

//#define _ASR_ENABLE_					DISABLE
...
#define _FD_FUNC_                       DISABLE//ENABLE
#define _TSR_FUNC_						DISABLE
#define MAX_FDNUM                       10
#define PIP_VIEW_FUNC                   ENABLE//DISABLE // PipView (ENABLE: display 2 sensor by PipView, DISABLE: display user selected sensor)
...
#define PIP_VIEW_LR                     ENABLE//DISABLE //(ENABLE: display 2 sensor by PipView in left, right view, side by side, DISABLE: normal pipview)
...
#define LOGFILE_FUNC                    DISABLE//ENABLE
...
#define IME_TMNR_FUNC					DISABLE//ENABLE
#define STAMP_PRIVATE_POOL              ENABLE
#define POWER_KEY_LONG_PRESS			ENABLE
#define MOVIE_MULTISTAMP_FUNC			DISABLE

#define WIFI_UI_DIRECT_MOBILE_LINKOK    ENABLE
#define USER_WATCH_DOG                  DISABLE//ENABLE
#define CARD_ERROR_RESET                ENABLE
#define AUDIO_SPEAKER_IC                DISABLE

#define ACC_BAT_5V                      DISABLE // Battery 5V Suply
#define LOWPOWER_DETECT                 ENABLE // B+ 12v lowpower detect
#define ACCOFF_TIMELAPSE                DISABLE// Timelapse when acc off

#endif //_PRJCFG_MTN51_H_
