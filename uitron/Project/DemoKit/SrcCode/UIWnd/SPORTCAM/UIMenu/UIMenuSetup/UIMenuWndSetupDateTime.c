...
INT32 UIMenuWndSetupDateTime_Tab_OnKeyMenu(VControl *, UINT32, UINT32 *);
...
//EVENT_ITEM(NVTEVT_KEY_MENU, UIMenuWndSetupDateTime_Tab_OnKeyMenu)
...
INT32 UIMenuWndSetupDateTime_Tab_OnKeyMenu(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
