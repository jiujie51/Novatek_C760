...
INT32 UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_OnKeyUp(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_UP, UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_OnKeyUp)
...
INT32 UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_OnKeyUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	UINT32  uiKeyAct;
