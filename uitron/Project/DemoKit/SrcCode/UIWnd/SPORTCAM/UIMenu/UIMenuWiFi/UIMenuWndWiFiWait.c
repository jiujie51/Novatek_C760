...
CTRL_LIST_ITEM(UIMenuWndWiFiWait_Connect_Text_Static)
CTRL_LIST_END
...
INT32 UIMenuWndWiFiWait_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	UxCtrl_SetShow(&UIMenuWndWiFiWait_Connect_Text_StaticCtrl, TRUE);
	snprintf(item1_Buf,32,"WiFi    PlayBack    Mode");
	UxStatic_SetData(&UIMenuWndWiFiWait_Connect_Text_StaticCtrl, STATIC_VALUE, Txt_Pointer(item1_Buf));
...
//----------------------UIMenuWndWiFiWait_Connect_Text_StaticCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndWiFiWait_Connect_Text_Static)
EVENT_END
