...
INT32 MenuCommonOption_List_OnKeyDown(VControl *, UINT32, UINT32 *);
INT32 MenuCommonOption_List_OnKeyUp(VControl *, UINT32, UINT32 *);
INT32 MenuCommonOption_List_OnKeyEnter(VControl *, UINT32, UINT32 *);
INT32 MenuCommonOption_List_OnKeyMenu(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(MenuCommonOption_List)
EVENT_ITEM(NVTEVT_KEY_DOWN, MenuCommonOption_List_OnKeyDown)
EVENT_ITEM(NVTEVT_KEY_UP, MenuCommonOption_List_OnKeyUp)
EVENT_ITEM(NVTEVT_KEY_ENTER, MenuCommonOption_List_OnKeyEnter)
EVENT_ITEM(NVTEVT_KEY_MENU, MenuCommonOption_List_OnKeyMenu)

EVENT_END

INT32 MenuCommonOption_List_OnKeyDown(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	TM_MENU    *pMenu;
	TM_PAGE    *pPage;
	TM_ITEM    *pItem;
...
INT32 MenuCommonOption_List_OnKeyUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	TM_MENU    *pMenu;
	TM_PAGE    *pPage;
	TM_ITEM    *pItem;
...
INT32 MenuCommonOption_List_OnKeyEnter(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	TM_MENU    *pMenu;
	TM_PAGE    *pPage;
	TM_ITEM    *pItem;
...
INT32 MenuCommonOption_List_OnKeyMenu(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
