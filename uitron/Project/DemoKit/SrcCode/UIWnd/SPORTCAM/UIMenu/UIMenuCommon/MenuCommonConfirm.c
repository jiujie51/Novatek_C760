...
INT32 MenuCommonConfirm_List_OnKeyDown(VControl *, UINT32, UINT32 *);
INT32 MenuCommonConfirm_List_OnKeyUp(VControl *, UINT32, UINT32 *);
INT32 MenuCommonConfirm_List_OnKeyEnter(VControl *, UINT32, UINT32 *);
INT32 MenuCommonConfirm_List_OnKeyMenu(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(MenuCommonConfirm_List)
EVENT_ITEM(NVTEVT_KEY_DOWN, MenuCommonConfirm_List_OnKeyDown)
EVENT_ITEM(NVTEVT_KEY_UP, MenuCommonConfirm_List_OnKeyUp)
EVENT_ITEM(NVTEVT_KEY_ENTER, MenuCommonConfirm_List_OnKeyEnter)
EVENT_ITEM(NVTEVT_KEY_MENU, MenuCommonConfirm_List_OnKeyMenu)
EVENT_END

INT32 MenuCommonConfirm_List_OnKeyDown(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
INT32 MenuCommonConfirm_List_OnKeyUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	if ((paramNum == 1) && paramArray[0] == NVTEVT_KEY_PRESS) {
...
INT32 MenuCommonConfirm_List_OnKeyEnter(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	if ((paramNum == 1) && paramArray[0] == NVTEVT_KEY_PRESS) {
		if (UxList_GetData(&MenuCommonConfirm_ListCtrl, LST_CURITM) == MenuCommonConfirm_List_ICON_OK_M) {
...
INT32 MenuCommonConfirm_List_OnKeyMenu(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
