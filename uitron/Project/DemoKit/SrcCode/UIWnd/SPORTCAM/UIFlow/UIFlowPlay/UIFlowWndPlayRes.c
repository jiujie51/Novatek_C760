...
SHOW_ITEM_GROUP(CMD_Group,Normal73,50,38,77,65)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Protect,0,50,38,77,65)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin83Rect,0,0,107,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin83)
SHOW_MAP_BODY(Skin83Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin83,0,0,107,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text85,0,0,107,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal82)
SHOW_MAP_BODY(Skin83)
SHOW_MAP_BODY(Text85)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal82,200,181,307,208)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin88Rect,0,0,81,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin88)
SHOW_MAP_BODY(Skin88Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin88,0,0,81,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text90,1,0,80,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal87)
SHOW_MAP_BODY(Skin88)
SHOW_MAP_BODY(Text90)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal87,227,32,308,59)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin93Rect,0,0,155,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin93)
SHOW_MAP_BODY(Skin93Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin93,0,0,155,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text95,28,-2,152,26,STRID_NULL,0,1280,0,0,2,1,1,0,0,0,0,0,0,0)
SHOW_ITEM_IMAGE(CMD_Image,Image96, 0, 0, 28,24, ICON_DIR_LEFT,0,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal92,5,211,160,238)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin99Rect,0,0,145,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin99)
SHOW_MAP_BODY(Skin99Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin99,0,0,145,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text101,0,-2,115,25,STRID_NULL,0,1280,0,0,2,1,1,0,0,2,0,0,0,0)
SHOW_ITEM_IMAGE(CMD_Image,Image102, 119, 0, 147,24, ICON_DIR_RIGHT,0,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal98,169,211,314,238)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin105Rect,0,0,111,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin105)
SHOW_MAP_BODY(Skin105Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin105,0,0,111,27)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon106, 0, 0, 111,27, ICONID_NULL,83886080,9,9,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal104)
SHOW_MAP_BODY(Skin105)
SHOW_MAP_BODY(Icon106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal104,12,181,123,208)

CREATE_STATE_ITEM_DATA(ICON_VOL_0107,STRID_NULL,ICON_VOL_0,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_1108,STRID_NULL,ICON_VOL_1,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_2109,STRID_NULL,ICON_VOL_2,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_3110,STRID_NULL,ICON_VOL_3,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_4111,STRID_NULL,ICON_VOL_4,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_5112,STRID_NULL,ICON_VOL_5,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_6113,STRID_NULL,ICON_VOL_6,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_7114,STRID_NULL,ICON_VOL_7,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_8115,STRID_NULL,ICON_VOL_8,NULL) 
SHOW_MAP_BEGIN(UIFlowWndPlay_StatusICN_Volume)
SHOW_MAP_BODY(Normal104)
SHOW_MAP_END

DECLARE_EVENT(UIFlowWndPlay_StatusICN_Volume)
STATE_LIST_BEGIN(UIFlowWndPlay_StatusICN_Volume)
STATE_LIST_ITEM(ICON_VOL_0107)
STATE_LIST_ITEM(ICON_VOL_1108)
STATE_LIST_ITEM(ICON_VOL_2109)
STATE_LIST_ITEM(ICON_VOL_3110)
STATE_LIST_ITEM(ICON_VOL_4111)
STATE_LIST_ITEM(ICON_VOL_5112)
STATE_LIST_ITEM(ICON_VOL_6113)
STATE_LIST_ITEM(ICON_VOL_7114)
STATE_LIST_ITEM(ICON_VOL_8115)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndPlay_StatusICN_Volume,0)
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volume,0,12,181,123,208)
