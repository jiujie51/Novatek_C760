...
extern void FlowPB_SetFullCropDisp(BOOL bCropDispFlag);
extern BOOL FlowPB_GetFullCropDisp(void);
extern void FlowPB_SetFullCropDispPrev(BOOL bCropDispFlag);
extern BOOL FlowPB_GetFullCropDispPrev(void);
