...
static void System_SensorGroupCfg(void)
{
	...
	SENSOR_AD_EXT_INFO ad_ext_info[VDOIN_MAX_NUM] = {0};
	...
	ad_ext_info[0].input_port  = SENSOR_MULTI_ID_1_INPORT;
	ad_ext_info[0].output_port = SENSOR_MULTI_ID_1_OUTPORT;
	ad_ext_info[0].signal      = SENSOR_MULTI_ID_1_SIG;
	ad_ext_info[1].input_port  = SENSOR_MULTI_ID_2_INPORT;
	ad_ext_info[1].output_port = SENSOR_MULTI_ID_2_OUTPORT;
	ad_ext_info[1].signal      = SENSOR_MULTI_ID_2_SIG;
	ad_ext_info[2].input_port  = SENSOR_MULTI_ID_3_INPORT;
	ad_ext_info[2].output_port = SENSOR_MULTI_ID_3_OUTPORT;
	ad_ext_info[2].signal      = SENSOR_MULTI_ID_3_SIG;
	ad_ext_info[3].input_port  = SENSOR_MULTI_ID_4_INPORT;
	ad_ext_info[3].output_port = SENSOR_MULTI_ID_4_OUTPORT;
	ad_ext_info[3].signal      = SENSOR_MULTI_ID_4_SIG;
	ad_ext_info[4].input_port  = SENSOR_MULTI_ID_5_INPORT;
	ad_ext_info[4].output_port = SENSOR_MULTI_ID_5_OUTPORT;
	ad_ext_info[4].signal      = SENSOR_MULTI_ID_5_SIG;
	ad_ext_info[5].input_port  = SENSOR_MULTI_ID_6_INPORT;
	ad_ext_info[5].output_port = SENSOR_MULTI_ID_6_OUTPORT;
	ad_ext_info[5].signal      = SENSOR_MULTI_ID_6_SIG;
	ad_ext_info[6].input_port  = SENSOR_MULTI_ID_7_INPORT;
	ad_ext_info[6].output_port = SENSOR_MULTI_ID_7_OUTPORT;
	ad_ext_info[6].signal      = SENSOR_MULTI_ID_7_SIG;
	ad_ext_info[7].input_port  = SENSOR_MULTI_ID_8_INPORT;
	ad_ext_info[7].output_port = SENSOR_MULTI_ID_8_OUTPORT;
	ad_ext_info[7].signal      = SENSOR_MULTI_ID_8_SIG;
	...
	drv_sensor_cfg_ad_ext(&ad_ext_info[0]);
			...
			if (uiSensorLUT[new_device_id] == SENSOR_1) {
				...
				if (uiSensorLUT[new_device_id] == SENSOR_2) {
		 			if (g_bFirstBootHotPlug == FALSE){
						...
						INT iNextMode= System_GetState(SYS_STATE_NEXTMODE);
						#endif
		 				if (iCurrMode == PRIMARY_MODE_MOVIE
						#if (defined(_NVT_ETHREARCAM_RX_))
						//bootup and changing to movie mode
							|| ((iNextMode == PRIMARY_MODE_MOVIE) && UI_IsForceLock())
						#endif
						){
