...
extern int SX_TIMER_DET_SYSTEM_ERROR_ID;
...
//-----------------------------------------------------------------------------
// User Partition & FW upgrade

typedef enum
{
	USR_PARTI_WAV_DATA = 0,
	USR_PARTI_DSA_VER,		// reserved for future use
	USR_PARTI_DSA_DATA,		// reserved for future use
	USR_PARTI_TSR_MODEL,	// reserved for future use
	ENUM_DUMMY4WORD(USR_PARTI_SECTION)
} USR_PARTI_SECTION;

typedef enum
{
	FW_UPDATE_TYPE_NONE = 0,
	FW_UPDATE_TYPE_FW,
	FW_UPDATE_TYPE_WAV,		// not support yet
	FW_UPDATE_TYPE_DSA,		// not support yet
	FW_UPDATE_TYPE_GPS,		// not support yet
	ENUM_DUMMY4WORD(FW_UPDATE_TYPE)
} FW_UPDATE_TYPE;

//extern void System_SetFwUpdateType(UINT32 type);
extern ER UserPartition_Read(INT8 *pReadBuf, UINT32 ulStartAddress, UINT32 ulDataLength, USR_PARTI_SECTION USR_PARTI_S);
extern ER UserPartition_Write(INT8 *pWriteBuf, UINT32 ulStartAddress, UINT32 ulDataLength, USR_PARTI_SECTION USR_PARTI_S);
//-----------------------------------------------------------------------------
