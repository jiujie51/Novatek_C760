...
#define DMA_WP				ENABLE
#define DMA_WP_ADDR			0x000024D4
#define DMA_WP_SIZE			0x00000008

#define CPU_WP				ENABLE
#define CPU_WP_CMD			"cwp on 000024D4"
...
int NvtMain(int argc, char *argv[])
{
    ...
    if(RtcDate.s.year < MIN_YEAR)
    {
        rtc_setDate(MIN_YEAR, DEF_MONTH, DEF_DAY);
        rtc_triggerCSET();
    }
