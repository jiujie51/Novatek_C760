...
#define SENSOR_GP_FUNC                  ENABLE//DISABLE

// Sensor group
//#define SENSOR_GP_1                     (SENSOR_MULTI_ID_1)//SENSOR_MULTI_ID_NONE /*ex: SENSOR_MULTI_ID_1|SENSOR_MULTI_ID_2*/
#define SENSOR_GP_1                     (SENSOR_MULTI_ID_1 | SENSOR_MULTI_ID_2)//SENSOR_MULTI_ID_NONE /*ex: SENSOR_MULTI_ID_1|SENSOR_MULTI_ID_2*/
...
#define SENSOR_MULTI_ID_1_SIG           3

#define SENSOR_MULTI_ID_2_INPORT        1
#define SENSOR_MULTI_ID_2_OUTPORT       0
#define SENSOR_MULTI_ID_2_SIG           3

// Sensor Insert Mask
//#define SENSOR_INSERT_MASK              (SENSOR_1 | SENSOR_2) // support insert sensor
