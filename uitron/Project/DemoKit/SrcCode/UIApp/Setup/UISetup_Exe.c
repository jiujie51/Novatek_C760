...
#else
				uiChangeTo = PRIMARY_MODE_PLAYBACK;//pqw
#endif
			} else
#if (PLAY_MODE==ENABLE)
...
///////////////////////////////////////////////////////////////////
INT32 SetupExe_OnLowBatteryLvl(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 uhSelect = 0;
    if(paramNum > 0)
        uhSelect = paramArray[0];
    UI_SetData(FL_LowBatteryLvl, uhSelect);
    return NVTEVT_CONSUME;

}

INT32 SetupExe_OnTimeLapse(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32 uhSelect = 0;
    if(paramNum > 0)
        uhSelect = paramArray[0];
    UI_SetData(FL_movie_timelapse_set, uhSelect);
    return NVTEVT_CONSUME;
...
{CHKPNT;
    ...
    debug_msg("Sys_AutoReboot, curr:  %04d/%02d/%02d %02d:%02d:%02d\r\n",
	...
	debug_msg("Sys_AutoReboot, alarm: %04d/%02d/%02d %02d:%02d:%02d\r\n",
	...
	debug_msg("Sys_AutoReboot, HWRT:  %04d/%02d/%02d %02d:%02d:%02d\r\n",
		alarmDateTime.tm_year, alarmDateTime.tm_mon, alarmDateTime.tm_mday, alarmDateTime.tm_hour, alarmDateTime.tm_min, alarmDateTime.tm_sec);
	rtc_waitCSETDone();
...
#endif
	{NVTEVT_EXE_SETUP_LOWBATTERYLVL,  SetupExe_OnLowBatteryLvl    },
	{NVTEVT_EXE_MOVIE_TIMELAPSESET,  SetupExe_OnTimeLapse         },
#endif
