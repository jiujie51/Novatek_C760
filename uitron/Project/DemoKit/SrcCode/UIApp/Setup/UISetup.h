...
#endif
	/* INSERT NEW EVENT HRER */
	NVTEVT_EXE_SETUP_LOWBATTERYLVL = 0x14080102,
	NVTEVT_EXE_MOVIE_TIMELAPSESET = 0x14080103,
}
CUSTOM_SYS_EVENT;
...
extern void Sys_SetPrevWifiMode(UINT32 mode);
extern UINT32 Sys_GetPrevWifiMode(void);
