...
static UINT8 MoviePlay_CapAesKey[16] = {0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F};
#endif
...
void MoviePlayExe_CapFileNamingCB(UINT32 id, char *pFileName)
{
...
#define MOVIEPLAY_CAP_ROOT_PATH         "A:\\Novatek\\"
#define MOVIEPLAY_CAP_FOLDER_NAME         "MPlay"
#define MOVIEPLAY_CAP_AES_KEY            "123456"

void MoviePlayExe_CapInitFileNaming(void)
{
	ImageApp_MoviePlay_Config(MOVIEPLAY_CONFIG_CAP_ROOT_PATH, (UINT32)MOVIEPLAY_CAP_ROOT_PATH);
	// Folder Naming
	ImageApp_MoviePlay_Config(MOVIEPLAY_CONFIG_CAP_FOLDER_NAME, (UINT32)MOVIEPLAY_CAP_FOLDER_NAME);
	ImageApp_MoviePlay_Config(MOVIEPLAY_CONFIG_CAP_FILE_NAME_CB, (UINT32)&MoviePlayExe_CapFileNamingCB);
    //#NT#2019/11/21#Philex -begin
    // capture encrypo
    #if PLAY_CAP_CRYPTO_FUNC
    ImageApp_MoviePlay_Config(MOVIEPLAY_CONFIG_CAP_SET_CRYPTO_KEY, (UINT32)MoviePlay_CapAesKey);
    ImageApp_MoviePlay_Config(MOVIEPLAY_CONFIG_CAP_SET_CRYPTO_LENGTH, 1024);
    #endif
    //#NT#2019/11/21#Philex -end
}
