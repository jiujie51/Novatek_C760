...
MOVIEMULTI_RECODE_FOLDER_NAMING gMovie_Folder_Naming[SENSOR_MAX_NUM] = {
	{
		_CFG_REC_ID_1,			//MOVIE_CFG_REC_ID
		"Front\\Movie",//"Movie",				//MOVIE_CFG_FOLDER_NAME   movie
		"Front\\RO",//"EMR",				//MOVIE_CFG_FOLDER_NAME   emr
		"Front\\Photo",//"Photo",//"Movie",				//MOVIE_CFG_FOLDER_NAME   snapshot  modify for autotest
...
MOVIEMULTI_RECODE_FOLDER_NAMING gMovie_EthCam_Folder_Naming[ETHCAM_PATH_ID_MAX] = {
	{
		...
		"Eth\\Movie",//"Movie_E",				//MOVIE_CFG_FOLDER_NAME   movie
		"Eth\\RO",//"EMR_E",				//MOVIE_CFG_FOLDER_NAME   emr
		"Eth\\Photo",//"Photo",//"Movie_E",				//MOVIE_CFG_FOLDER_NAME   snapshot  modify for autotest
		TRUE,					//MOVIE_CFG_FILE_NAMING   2018/02/13
	},
	{
		...
		"Photo",//"Movie_E",				//MOVIE_CFG_FOLDER_NAME   snapshot  modify for autotest
		TRUE,					//MOVIE_CFG_FILE_NAMING   2018/02/13
	},
};

MOVIEMULTI_AUDIO_INFO   gMovie_Audio_Info = {
#if ((_BOARD_DRAM_SIZE_ == 0x04000000) || (SENSOR_CAPS_COUNT >= 2) ||  ((defined(_NVT_ETHREARCAM_RX_)) && (ETH_REARCAM_CAPS_COUNT >= 2)) || defined(_ASR_ENABLE_))
	16000,                     //MOVIE_CFG_AUD_RATE
	AUDIO_CH_RIGHT,            //MOVIE_CFG_AUD_CH
	1,                         //MOVIE_CFG_AUD_CH_NUM
#else
	16000,//32000,                     //MOVIE_CFG_AUD_RATE
