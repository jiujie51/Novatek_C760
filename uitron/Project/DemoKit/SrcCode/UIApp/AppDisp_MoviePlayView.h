...
typedef struct _CROP_VIDEO_PLAY{
	IRECT  SrcCropRect;
	ISIZE  VdoOrigSize;	
}CROP_VIDEO_PLAY;
...
extern void AppDisp_MoviePlayView_InitSrcVdoCropInfo(CROP_VIDEO_PLAY *pSrcVdoCropInfo);
extern void AppDisp_MoviePlayView_SetSrcVdoCropInfo(CROP_VIDEO_PLAY *pCropVdoPlayInfo);
extern CROP_VIDEO_PLAY AppDisp_MoviePlayView_GetSrcVdoCropInfo(void);
