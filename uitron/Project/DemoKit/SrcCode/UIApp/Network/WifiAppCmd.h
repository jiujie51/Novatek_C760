...
//#NT#
#define WIFIAPP_CMD_WIFIAP_SEARCH             3039
//#NT#2016/06/06#Charlie Chang -end
#define WIFIAPP_CMD_MOVIE_PARK_HCTX             3038
//#define WIFIAPP_CMD_MOVIE_PARK_TMX            3040
#define WIFIAPP_CMD_TMX_TIMELAPSE_TIME			3040
...
#define WIFIAPP_CMD_MOVIE_PARK     		 8005

#define WIFIAPP_CMD_GET_DAULCAM          8007

#define WIFIAPP_CMD_DRIVE_ASIST          8020


//#Miotone#Liwk -20161124 -begin
//Wi-Fi cmd for factory test
#define WIFIAPP_CMD_KEY1_TEST             9001
#define WIFIAPP_CMD_KEY2_TEST             9002
#define WIFIAPP_CMD_LED_TEST              9003
#define WIFIAPP_CMD_UID_BURNIN            9004
#define WIFIAPP_CMD_KEY3_TEST             9005
#define WIFIAPP_CMD_KEY4_TEST             9006
...
#define WIFIAPP_RET_TEST_KEY_TIMEOUT    (-23)
#define WIFIAPP_RET_GSENSOR_INT_TIMEOUT    (-24)
...
#define WIFIFLAG_TEST_KEY1_DONE               FLGPTN_BIT(8) //0x000000100   
#define WIFIFLAG_TEST_KEY2_DONE               FLGPTN_BIT(9) //0x000000200   
#define WIFIFLAG_TEST_KEY3_DONE               FLGPTN_BIT(10)
#define WIFIFLAG_TEST_KEY4_DONE               FLGPTN_BIT(11)
//#define WIFIFLAG_TEST_KEY5_DONE               FLGPTN_BIT(12)
#define WIFIFLAG_GSENSOR_PARK_INT_DONE   	  FLGPTN_BIT(13)
