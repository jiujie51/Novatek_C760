...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK_HCTX, NVTEVT_WIFI_EXE_MOVIE_PARK, 0, 0, FL_MOVIE_PARK)
#if(!FACTORY_TEST_MODE)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK, NVTEVT_WIFI_EXE_MOVIE_PARK, 0, 0, FL_MOVIE_PARK)
#endif
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK_TMX, NVTEVT_WIFI_EXE_MOVIE_PARK, 0, 0, FL_MOVIE_PARK)
WIFI_CMD_ITEM(WIFIAPP_CMD_TMX_TIMELAPSE_TIME, NVTEVT_WIFI_EXE_TIMELAPSE_TIME, 0, 0, FL_MOVIE_TIMELAPSE_TIME)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_DAULCAM, 0, (UINT32)XML_GetDualCamShow, 0, FL_NULL)
//#Miotone#Liwk -20161124 -begin
#if(FACTORY_TEST_MODE)
//for factory test
WIFI_CMD_ITEM(WIFIAPP_CMD_KEY1_TEST,NVTEVT_WIFI_EXE_KEY1 ,0,WIFIFLAG_TEST_KEY1_DONE, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_KEY2_TEST,NVTEVT_WIFI_EXE_KEY2 ,0,WIFIFLAG_TEST_KEY2_DONE, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_KEY3_TEST,NVTEVT_WIFI_EXE_KEY3 ,0,WIFIFLAG_TEST_KEY3_DONE, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_KEY4_TEST,NVTEVT_WIFI_EXE_KEY4 ,0,WIFIFLAG_TEST_KEY4_DONE, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_LED_TEST,NVTEVT_WIFI_EXE_LED,0,0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK, NVTEVT_WIFI_EXE_MOVIE_PARK, 0, WIFIFLAG_GSENSOR_PARK_INT_DONE, FL_NULL)
#endif
//WIFI_CMD_ITEM(WIFIAPP_CMD_UID_BURNIN, 0, (UINT32)XML_UIDBurIn, 0, FL_NULL)
//#Miotone#Liwk -20161124 -end
