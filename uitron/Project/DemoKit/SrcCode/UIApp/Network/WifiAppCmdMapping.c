...
WIFIAPPINDEXMAP movieSizeMap[] = {
	...
	#else
	{MOVIE_SIZE_FRONT_3840x2160P30, "3840x2160P30"},
	{MOVIE_SIZE_FRONT_2560x1440P30, "2560x1440P30"}, 
	{MOVIE_SIZE_FRONT_1920x1080P30, "1920x1080P30"}, 
	#endif
	{INDEX_END, 0}
};
#endif
...
WIFIAPPINDEXMAP TimeLapseMap[] = {
	{MOVIE_TIMELAPSE_SET_OFF, "Off"},
	{MOVIE_TIMELAPSE_SET_12HOUR,  "12HOUR"},	
	{MOVIE_TIMELAPSE_SET_24HOUR,  "24HOUR"},
	{MOVIE_TIMELAPSE_SET_48HOUR,  "48HOUR"},	
	{INDEX_END, 0}
};
WIFIAPPINDEXMAP ParkMap[] = {
	{MOVIE_PARK_OFF, "Off"},
	{MOVIE_PARK_LOW,  "Low"},	
	{MOVIE_PARK_MED,  "Med"},	
	{MOVIE_PARK_HIGH,  "High"},
	{INDEX_END, 0}
};
...
WIFIAPPMAP wifiAppFlagMap[] = {
	...
	{FL_MOVIE_TIMELAPSE_TIME,  "MOVIE_TIMELAPSE_TIME",  TimeLapseMap},
	{FL_MOVIE_PARK,            "MOVIE_PARK",            ParkMap},
	{FL_NULL, 0},
};
