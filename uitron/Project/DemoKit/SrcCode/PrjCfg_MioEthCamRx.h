...
#define FACTORY_TEST_MODE               DISABLE
...
#if 0//defined(_NVT_ETHREARCAM_CAPS_COUNT_2_)
...
//VX.A.BC
/*
//X:sdk版本，1:20200226,  2:20200522，3:20200819...
//A:硬件版本，1:首版，2:第二版(换屏)，3:第三版，类推...
//BC:软件小版本
*/
#if(FACTORY_TEST_MODE)
#define FW_VERSION_NUM 					"CAR_DVR_20161206 V1.1.2" // factory test app version
#else
#define FW_VERSION_NUM                  "C760_V2.2.00"// "C760_V1.2.01"//"C760_V1.2.00"//"C760_V2.04"//"C760_V2.03"//"C760-6112-20200522 V2.02"//"REGULAR_0402_001"
#endif
//..............................................................................
/**
...
#define POWERONLOGO_FUNCTION            ENABLE//DISABLE
#define POWEROFFLOGO_FUNCTION           ENABLE//DISABLE //ENABLE
...
// OSD size and format
#if 0//defined(_Disp_IF8B_LCD1_ZHIDING_FY35003_ST7272A_)
#define DISPLAY_OSD_W                   320//640
#define DISPLAY_OSD_H                   240
#elif 0//defined(_Disp_IFPA_LCD1_AM350Y10_54E_N02_)
#define DISPLAY_OSD_W                   640
#define DISPLAY_OSD_H                   480
#elif 0//defined(_Disp_IF8B_LCD1_AM350Y10_54E_N02_)
#define DISPLAY_OSD_W                   640
#define DISPLAY_OSD_H                   480
#else
#define DISPLAY_OSD_W                   320//640
...
#elif defined(_Disp_IF8B_LCD1_ZHIDING_FY35003_ST7272A_)
#define LCDMODE                         DISP_LCDMODE_RGB_THROUGH
#elif defined(_Disp_IFPA_LCD1_AM350Y10_54E_N02_)
#define LCDMODE                         DISP_LCDMODE_RGB_PARALL565
#elif defined(_Disp_IF8B_LCD1_AM350Y10_54E_N02_)
#define LCDMODE                         DISP_LCDMODE_RGB_THROUGH
#else
#error "Unknown _LCD_"
#endif
...
#define DUALCAM_PIP_BEHIND_FLIP   DISABLE//      DISABLE  //Flip 2nd cam image in PIP view. Need extra 1/2 VDO buffer
...
#define IMG_FULL_DISP					DISABLE//ENABLE
#define MOVIE_MODE_D2D_FUNC    			ENABLE//DISABLE

#define ACCOFF_TIMELAPSE                ENABLE//DISABLE// Timelapse when acc off


#define AUDPROC_FUNC                    ENABLE
...
#define ESD_RESET_FUNCTION   			ENABLE
#define MT_PASSWORD                  	ENABLE

#define TF_FORMAT_MARK_NAME             "A:\\MISC\\format.txt"  //for sd card FORMAT
