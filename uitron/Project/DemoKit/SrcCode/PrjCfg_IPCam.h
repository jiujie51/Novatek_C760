...
#define IPCAM_FTG_USE_CPU_CLARITY   DISABLE // enable clarity evb version (!choose clarity between evb and dsp version!)
#define IPCAM_FTG_USE_DSP_CLARITY   DISABLE // enable clarity dsp version (!need pack DSP1.bin!)
#define IPCAM_FTG_USE_DSP_LANDMARK  DISABLE // enable landmark (!need pack DSP1.bin!)
