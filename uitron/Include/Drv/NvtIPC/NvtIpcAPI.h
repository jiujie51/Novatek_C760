...
*/
extern NVTIPC_I32  NvtIPC_IsCacheAddr(UINT32 addr);

/**
    Set cpu2 logfile ring buffer address and size.

    @param addr: the buffer address.
    @param size: the buffer size.

    @return NVTIPC_ER_OK or errors
*/
extern NVTIPC_I32 NvtIPC_SetCpu2LogBuf(UINT32 addr, UINT32 size);
