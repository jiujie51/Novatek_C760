...
typedef enum {
	...
	I2C_CONFIG_ID_SCLTIMEOUT_CHECK, ///< Enable/Disable the SCL Timeout Check. Default is disabled.
    ...
    I2C_CONFIG_ID_TIMEOUT_PERIOD,	///< Setting I2C driver transmit/receive timeout value. default is 0 means no timeout. Unit in ms.
	I2C_CONFIG_ID_UNLOCK_RST_TRIG,	///< One Shot trigger the i2c driver reset during next i2c_unlock. uiConfig input is useless.
...
typedef enum {
	...
	I2C_STS_TIMEOUT,				///< (Driver status) transmit/receive timeout
