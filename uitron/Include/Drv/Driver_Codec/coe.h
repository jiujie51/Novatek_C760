...
typedef struct {
	COE_WIN coe_win[2][16];
	BOOL    check;                ///< 0: not check violation; 1: check violation
}K_COE_CONFIG, *PK_COE_CONFIG;
...
extern ER       coe_check_violation(PK_COE_CONFIG p_coe_config, BOOL hevc);
