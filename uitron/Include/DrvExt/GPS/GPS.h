...
#else//±±∂∑∏Ò Ω(GPS+GLONASS)
#define GSA_SENTENCE			0x4153474E //'A''S''G''N'
#define RMC_SENTENCE			0x434D524E //'C''M''R''N'
#define GGA_SENTENCE			0x4147474E //'A''G''G''N'
#define GSV_SENTENCE			0x56534750 //'V''S''G''P'
#define GLL_SENTENCE			0x4C4C4750 //'L''L''G''P'
#define VTG_SENTENCE			0x47545650 //'G''T''V''P'
#define SNR_SENTENCE			0x4F534E45 //'O''S''N''E'
...
extern UINT32 GPSRec_GetGSVSatInView(void);//pqw add
