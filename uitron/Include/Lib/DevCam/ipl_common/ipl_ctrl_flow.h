...
typedef enum _IPC_RUNTIMECHG_IQ {
	...
	IPC_DCE_IQLoad_ISR  = 0xe0000000,   ///< chg DCE iq parameter ISR load                  ,data type :IPC_IQparam
	IPC_IFE2_IQLoad_ISR  = 0xf0000000,   ///< chg IFE2 iq parameter ISR load                ,data type :IPC_IQparam
