...
typedef enum {
    ...
    AFALG_CFG_DYNAMIC_BACKLASH, ///< AF algorithm dynamic backlash
...
typedef INT32  (*AF_FOCUS_DOACTION_CBFP)(INT32 target_pos);
typedef INT32  (*AF_FOCUS_GETPOSITION_CBFP)(void);
typedef INT32  (*AF_FOCUS_GETRANGE_CBFP)(void);
typedef UINT32 (*AF_ZOOM_GETSECTION_CBFP)(UINT8 category);
