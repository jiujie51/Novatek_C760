...
typedef enum {
	...
	USBMSDC_CONFIG_ID_COMPOSITE_EVT_CB,								///< Composite device usb event callback.
																	///< prototype:  "void callback_func(UINT32 event)"
	USBMSDC_CONFIG_ID_COMPOSITE_CLASSREQ_CB,						///< Composite device usb class-request callback.
																	///< prototype:  "void callback_func(void)"
	USBMSDC_CONFIG_ID_COMPOSITE_OPENFIFO_CB,						///< Composite device usb open needed fifo callback.
																	///< prototype:  "void callback_func(void)"
	USBMSDC_CONFIG_ID_COMPOSITE_OPENFUNC_CB,						///< Composite device usb open function callback.
																	///< prototype:  "void callback_func(UINT32 event)"
	USBMSDC_CONFIG_ID_COMPOSITE_CLOSEFUNC_CB,						///< Composite device usb close func callback.
