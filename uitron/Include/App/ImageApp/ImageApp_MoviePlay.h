...
enum {
	...
	/* Cap*/
	MOVIEPLAY_CONFIG_CAP_ROOT_PATH,                 ///< cap file root path
	MOVIEPLAY_CONFIG_CAP_FOLDER_NAME,                 ///< cap file folder name
	MOVIEPLAY_CONFIG_CAP_FILE_NAME_CB,		///< cap file naming callback
	MOVIEPLAY_CONFIG_CAP_WRITEFILE_CB,		///< cap file write callback
	MOVIEPLAY_CONFIG_CAP_ENABLE,			///< cap function Enable
	MOVIEPLAY_CONFIG_CAP_SET_CRYPTO_KEY,		///< set crypto key
	MOVIEPLAY_CONFIG_CAP_SET_CRYPTO_LENGTH,		///< set crypto data length
};
...
typedef enum {
	...
	MOVIEPLAY_NM_PARAM_USER_BLK_DIRECTLY,                 ///< user define filein block size directly
	MOVIEPLAY_NM_PARAM_BLK_SIZE,                          ///< size per one read file block
	...
	MOVIEPLAY_NM_PARAM_COMM_WORK_BUF,                     ///< work buffer using common pool
...
/**
    ...
    @return ISF_RV
*/
extern ISF_RV ImageApp_MoviePlay_FilePlay_StopAudio(void);
...
/**
    ...
    @return ISF_RV
*/
ISF_RV ImageApp_MoviePlay_Trig_Cap(void);
...
/**
    ...
    @return ISF_RV
*/
ISF_RV ImageApp_MoviePlay_Jump(UINT32 uiFrmIdx);
//@}
