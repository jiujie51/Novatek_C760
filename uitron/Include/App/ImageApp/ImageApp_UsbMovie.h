...
typedef enum {
	...
	USBMOVIE_CFG_UVC_BUF,               ///< use specified buffer by PMEM_RANGE for UVC
	USBMOVIE_CFG_D2D_MODE,              ///< direct mode enable
	USBMOVIE_CFG_USER_CB_EVENT,
	USBMOVIE_CFG_MAX,
} USBMOVIE_CFG;
...
typedef enum {
	// EVENT
	USBMOVIE_USER_CB_EVENT_STAMP_CB = 0x0000D300,
	ENUM_DUMMY4WORD(USBMOVIE_USER_CB_EVENT)
} USBMOVIE_USER_CB_EVENT;
typedef struct {
	UVAC_VID_IN         vid_in;
...
extern void ImageApp_UsbMovie_InstallID(void);
