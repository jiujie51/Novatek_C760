...
enum {
	...
	MOVIE_CONFIG_MAX_LINK_INFO,       // Please config this first before any set param operation
};
...
typedef enum {
	...
	MOVIE_USER_CB_EVENT_DEC_ONEFRAME,
...
typedef enum {
	...
	_CFG_MAIN_EMR_LOOP   = 0x00000008,    /// Main EMR only
