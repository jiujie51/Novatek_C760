...
typedef INT32 HFSNVT_UPLOAD_RESULT_CB(int result, UINT32 bufAddr, UINT32 *bufSize, CHAR *mimeType, UINT32 segmentCount);  ///< Callback function for upload command complete
