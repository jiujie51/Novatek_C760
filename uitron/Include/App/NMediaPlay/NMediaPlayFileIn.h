...
typedef enum {
	...
	NMI_FILEIN_PARAM_USER_BLK_DIRECTLY, ///< user define filein block size directly
	NMI_FILEIN_PARAM_BLK_SIZE,          ///< size per one block (e.g. 1 sec per block)
	...
	NMI_FILEIN_PARAM_VDO_TTFRM,         ///< video total frame number
	NMI_FILEIN_PARAM_AUD_TTFRM,         ///< audio total frame number
} NMI_FILEIN_PARAM;
