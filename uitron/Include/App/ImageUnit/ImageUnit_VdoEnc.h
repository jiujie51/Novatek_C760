...
extern ISF_RV _ISF_ImgCap_LockCB(UINT64 module, UINT32 hData);
extern ISF_RV _ISF_ImgCap_UnLockCB(UINT64 module, UINT32 hData);
extern ISF_RV _ISF_ImgCap_AllocMem(ISF_UNIT *pThisUnit, UINT32 id);
extern ISF_RV _ISF_ImgCap_FreeMem(ISF_UNIT *pThisUnit, UINT32 id);
