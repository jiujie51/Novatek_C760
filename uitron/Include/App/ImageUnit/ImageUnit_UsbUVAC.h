...
enum {
	...
	UVAC_PARAM_CT_CB,               ///< UVC Camera Terminal capability.
    UVAC_PARAM_PU_CB,               ///< UVC Processing Unit capability.
    UVAC_PARAM_DFU_INFO,            ///< Set DFU function, referring to UVAC_DFU_INFO.
    UVAC_PARAM_RELEASE_CB_ENABLE,   ///< Enable release buffer mechanism.
    UVAC_PARAM_MAX_AUDIO_FRAME_SIZE,///< Max audio frame size.
	UVAC_PARAM_MAX
};

extern ISF_UNIT ISF_UsbUVAC;
extern void ISF_UsbUVAC_InstallID(void);
