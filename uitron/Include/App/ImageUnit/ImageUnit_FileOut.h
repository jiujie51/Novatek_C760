...
typedef enum {
	FILEOUT_CB_RETVAL_DONE,
	FILEOUT_CB_RETVAL_NOFREE_SPACE,
	FILEOUT_CB_RETVAL_PARAM_ERR,
	FILEOUT_CB_RETVAL_DELETE_FAIL,
	FILEOUT_CB_RETVAL_CHKRO_FAIL,
	ENUM_DUMMY4WORD(FILEOUT_CB_RETVAL)
} FILEOUT_CB_RETVAL;
typedef struct {
	UINT32 iport;
	UINT32 event;
