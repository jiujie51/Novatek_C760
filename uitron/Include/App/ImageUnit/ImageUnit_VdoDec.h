...
typedef enum {
	...
	VDODEC_PARAM_COMM_WORK_BUF,                                          ///< work buffer using common pool
	VDODEC_PARAM_USE_IMG_BUF_PKG,
	VDODEC_PARAM_MAX,
	VDODEC_PARAM_RAW_DATA_CB,
	VDODEC_PARAM_SRC_OUT_CB,
	VDODEC_PARAM_SNAPSHOT,
	// ImgCap
	VDODEC_PARAM_IMGCAP_THUMB,
	VDODEC_PARAM_IMGCAP_ACTION,
	VDODEC_PARAM_IMGCAP_W,
	VDODEC_PARAM_IMGCAP_H,
	VDODEC_PARAM_IMGCAP_JPG_BUFNUM, 	// set jpg buffer number
	VDODEC_PARAM_IMGCAP_GET_JPG_ADDR,	// get jpg encoded addr
	VDODEC_PARAM_IMGCAP_GET_JPG_SIZE,	// get jpg encoded size
	VDODEC_PARAM_IMGCAP_MAX_MEM_INFO,
	VDODEC_PARAM_IMGCAP_FUNC_DISABLE,	// ImgCap Function Disable, 0: func enable (default) / 1: func disable
	VDODEC_PARAM_IMGCAP_EXIF_FUNC,		// EXIF function (1: on, 0: off)
