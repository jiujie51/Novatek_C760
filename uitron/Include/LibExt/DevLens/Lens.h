...
/**
     Get lens driver IC's name.

     @param[in] name's pointer
     @ void
*/
extern void Lens_GetDriverName(INT8 *ic_name);
...
/**
     Get status of lens initialization state.

     @return bit0: zoom / bit1: focus (1: init OK).
*/
extern UINT32 Lens_GetInitState(void);
...
/**
     Zoom in/out until Lens_ZoomStop().

     @param[in] move_mode
     @return Description of data returned.
         - @b INT32: ERR_OK or ERR_OPERATION_FAIL.
*/
extern INT32 Lens_ZoomMove(UINT32 move_mode);
...
*/
extern INT32 Lens_FocusDoAction(INT32 position);

/**
     Move focus position to un-restricted target.

     @param[in] position               Focus physical position.
     @return Description of data returned.
         - @b INT32: focus real move step.
*/
extern INT32 Lens_FocusDoFreeAction(INT32 position);

/**
     Focus wide/tele until Lens_FocusStop().

     @param[in] move_mode       Move mode (0 ~ 3)
     @return Description of data returned.
         - @b INT32: ERR_OK or ERR_OPERATION_FAIL.
*/
extern INT32 Lens_FocusMove(UINT32 move_mode);
...
/**
     Set aperture open/close operation.

     @param[in] lum_flux              open or close cmd value for DC-IRIS.

     @return Description of data returned.
         - @b INT32: ERR_OK or ERR_OPERATION_FAIL.
*/
extern INT32 Lens_ApertureSetLumFlux(UINT32 lum_flux);
