...
static AE_EXPECT_LUM expect_lum = {
    496, // mov
    496, // photo
    {30,35,40,45,55,65,75,80,85,85,90,90,95,95,95,95,95,95,95,95,95}, // mov
    {32,33,35,40,45,55,65,75,80,85,88,90,95,95,95,95,95,95,95,95,95}, // mov
	{22,25,30,35,45,55,65,75,80,85,88,90,95,95,95,95,95,95,95,95,95}, // mov
};
...
static AE_OVER_EXPOSURE over_exposure = {
    ENABLE,
    846,
    { 65, 65, 70, 75, 75, 80, 80, 80, 80, 80, 85, 85, 90, 90, 90, 95, 95, 100, 100, 100, 100},//判断过曝的阈值百分比
    
	{ 60, 65,  70,  75,  80,  85, 95,  105,  110,  120, 130, 140, 140, 140, 140, 140, 140, 140, 140, 140, 140},//过曝时需要减去的最高亮度，绝对值  movie

	{ 6,  10,  20,	30,  50,  70,  90,	100,  110, 120, 137, 147, 152, 156, 156, 156, 156, 156, 156, 156, 156},//过曝时需要减去的最高亮度，绝对值  photo
    { 6,  10,  20,	30,  50,  70,  90,	100,  110, 120, 137, 147, 152, 156, 156, 156, 156, 156, 156, 156, 156},//过曝时需要减去的最高亮度，绝对值  ir

	{ 6,  6,  8,	10,  20,  30,  40,	50,  60, 70, 80, 90, 90, 100, 110, 120, 130, 140, 150, 156, 156},//过曝区域统计的最大值

	{  3,   3,   3,   3,   4,   5,   6,   6,   7,   7,   7,   7,   7,   8,   8,   8,   8,   8,   8,   8,   8},//过曝区域统计的最小值
};
