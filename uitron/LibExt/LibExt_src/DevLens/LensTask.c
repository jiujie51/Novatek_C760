...
void LensCtrl_Tsk(void)
{
    ...
    while (g_uiLensTaskID) {
        ...
        if (ctrl_flag & FLGLENS_ZOOM_SETSTATE) {
            ...
            case LENS_ZOOM_OUT:
                Lens_ZoomMove(ZOOM_OUT);
                break;

            case LENS_ZOOM_IN:
                Lens_ZoomMove(ZOOM_IN);
                break;
    ...
    while (g_uiLensFocusTaskID) {
        ...
        if (ctrl_flag & FLGLENS_FOCUS_SETSTATE) {
            ...
            case LENS_FOCUS_GO2_POSITION:
                Lens_FocusDoAction((INT32)g_LensCtrlParam.uiFocusParam);
                break;

            case LENS_FOCUS_GO2_FREE_POSITION:
                Lens_FocusDoFreeAction((INT32)g_LensCtrlParam.uiFocusParam);
                break;

            case LENS_FOCUS_WIDE:
                Lens_FocusMove(FOCUS_WIDE);
                break;

            case LENS_FOCUS_TELE:
                Lens_FocusMove(FOCUS_TELE);
                break;

            case LENS_FOCUS_WIDE_SIDE:
                Lens_FocusMove(FOCUS_WIDE_SIDE);
                break;

            case LENS_FOCUS_WIDE_TELE_MIDDLE:
                Lens_FocusMove(FOCUS_WIDE_TELE_MIDDLE);
                break;

            case LENS_FOCUS_TELE_SIDE:
                Lens_FocusMove(FOCUS_TELE_SIDE);
                break;
