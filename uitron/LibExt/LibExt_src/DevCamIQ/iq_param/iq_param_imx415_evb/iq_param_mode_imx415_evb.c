#ifndef _IQ_PARAM_MODE_IMX415_EVB_C
#define _IQ_PARAM_MODE_IMX415_EVB_C
...
static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
    iq_param_imx415_evb_table1_init, //IQS_PARAM_TABLE1
    iq_param_imx415_evb_table2_init, //IQS_PARAM_TABLE2
    NULL,
};
...
void iq_param_init_imx415_evb(UINT32 Id);
void iq_param_init_imx415_evb(UINT32 Id)
{
