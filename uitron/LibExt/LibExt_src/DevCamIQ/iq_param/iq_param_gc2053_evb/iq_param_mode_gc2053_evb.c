#ifndef _IQ_PARAM_MODE_GC2053_EVB_C
#define _IQ_PARAM_MODE_GC2053_EVB_C
#include "note.h"
...
static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
	iq_param_gc2053_evb_table1_init, //IQS_PARAM_TABLE1
    NULL,
};
...
void iq_param_init_gc2053_evb(UINT32 Id);
