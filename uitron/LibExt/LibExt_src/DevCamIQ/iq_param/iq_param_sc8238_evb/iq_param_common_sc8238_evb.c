#ifndef _IQ_PARAM_COMMON_SC8238_EVB_C
#define _IQ_PARAM_COMMON_SC8238_EVB_C

#include "iq_param_common_sc8238_evb.h"

ISOMAP iso_map_tab_sc8238_evb[IQS_ISOMAPTAB_NUM] =
{
    {  100, IQS_GAIN_1X},
    {  200, IQS_GAIN_2X},
    {  400, IQS_GAIN_4X},
...
S_DEFOG_LIB_INIT_PARA defog_init_param_sc8238_evb =
{
	{32,32, 40, 40, 50, 50, 64, 64, 64},
	255
};

UINT32 defog_wet_sc8238_evb[17] =
{
...
UINT32 ldc_g_lut_sc8238_evb[65] =
{
...
//**  IPE-CC
//////////////////////
IQS_COLOR_TEMPERATURE_TH color_temperature_th_sc8238_evb =
{
    //Low,  Middle, High
    2800,   5000,   6500
};

IQS_COLOR_TEMPERATURE_PARAM color_low_sc8238_evb =
{
    {//CCM A
    0x0109, 0x0029, 0x0fce,
    0x0f78, 0x017f, 0x0009,
    0x0fce, 0x0e48, 0x02ea
    },
...
IQS_COLOR_TEMPERATURE_PARAM color_middle_sc8238_evb =
{
    {//CCM TL84
    0x0178, 0x0fa3, 0x0fe5,
    0x0f97, 0x01a7, 0x0fc2,
    0x0fe7, 0x0f08, 0x0211
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
IQS_COLOR_TEMPERATURE_PARAM color_high_sc8238_evb =
{
    {//CCM D65
    0x01bc, 0x0f6e, 0x0fd6,
    0x0fb2, 0x01d1, 0x0f7d,
    0x0ff2, 0x0f2e, 0x01e0
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
UINT8 fs_tab_sc8238_evb[TOTAL_GAIN_NUM][16] =
{
...
UINT8 fd_tab_sc8238_evb[TOTAL_GAIN_NUM][16] =
{
...
IPE_CC cc_sc8238_evb =
{
    CC_3_8, toIdentity, CC_PRE_GAMMA, CC_SEL_MAX, CC_OFS_BYPASS_SEL, (UINT32)color_high_sc8238_evb.IQS_CC, (UINT32)fs_tab_sc8238_evb, (UINT32)fd_tab_sc8238_evb
};

//////////////////////
//**  IPE-Ycurve
//////////////////////
UINT32 y_curve_sc8238_evb[129] = //linear
{
...
//**  IPE-Gamma
//////////////////////
IQS_GAMMA_LV_TH gamma_lv_th_sc8238_evb =
{
    //DAY,  NIGHT,
    600,    400
};

UINT32 gamma_day_sc8238_evb[129] =
{
    0,39,70,100,123,154,180,200,220,240,
    260,280,300,315,331,345,360,373,386,398,
    409,420,430,440,449,459,469,479,489,499,
    509,518,527,537,545,553,561,569,576,584,
    592,599,607,614,622,629,636,643,650,658,
    664,671,678,685,691,698,704,711,717,723,
    730,736,742,748,754,760,764,769,774,779,
    784,788,793,798,803,807,812,817,821,826,
    830,835,839,844,848,853,857,862,866,870,
    875,879,883,888,892,896,900,905,909,913,
    917,921,925,929,933,937,941,945,949,953,
    957,961,964,968,972,976,979,983,987,991,
    994,998,1001,1005,1009,1012,1016,1019,1023
};

UINT32 gamma_night_sc8238_evb[129] =
{
...
//**  IPE-CCtrl
//////////////////////
UINT8 edg_tab_sc8238_evb[24] =
{
    128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128
};

UINT8 dds_tab_sc8238_evb[8] =
{
...
//**  IPE-CST
//////////////////////
INT16 cst_coef_sc8238_evb[9] =
{
    77, 150, 29, -43, -85, 128, 128, -107, -21
};

IPE_CST cst_sc8238_evb =
{
    (UINT32)cst_coef_sc8238_evb, CST_SEL_MINUS128, 0
};

//////////////////////
//**  IPE-YCCFIX
//////////////////////
IPE_YCCFIX ycc_fix_sc8238_evb =
{
...
//**  IPE-NoiseParam
//////////////////////
IPE_RAND_NR noise_param_sc8238_evb =
{
...
//**  IPE-GammaRand
//////////////////////
 IPE_GamRand gamma_rand_sc8238_evb =
{
    FALSE, 0, 0
};
...
//////////////////////
UINT32 color_3d_lut_sc8238_evb[900] =
{
...
IPE_3DCCRound color_3d_sc8238_evb = {SEL_RANDOM, TRUE};

IME_TMNR_DISPMOMAP tmnr_momap_sel_sc8238_evb = IME_TMNR_DISPMOMAP_NONE;

IQS_SHDR_EVRATIO_TH hdr_lv_th_sc8238_evb =
{
    //High, Middle, Low,
    2048,	1024,	512
};

SHDR_IQ_PARA hdr_high_sc8238_evb =
{
...
SHDR_IQ_PARA hdr_middle_sc8238_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_low_sc8238_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
IQS_PATHCURVE_LV_TH pathcurve_lv_th_sc8238_evb =
{
    //High, Middle, Low,
    1400,   600,    400
};

UINT32 pathcurve_high_sc8238_evb[33] = 
{
...
UINT32 pathcurve_middle_sc8238_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
UINT32 pathcurve_low_sc8238_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
TMNR_AUTO_INFO tmnr_auto_info_sc8238_evb =
{
