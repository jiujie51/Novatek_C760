...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
#if defined(_EMBMEM_SPI_NOR_)
    #if 0//Pstore On,No User Partition;
    [0] = {EMBTYPE_LOADER,	0,	BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [2] = {EMBTYPE_UITRON,	0,	BLK_UNIT(0x00020000), BLK_UNIT(0x00280000), BLK_UNIT(0x00000000)},
    [3] = {EMBTYPE_UBOOT,	0,	BLK_UNIT(0x002a0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},    
    [4] = {EMBTYPE_PSTORE,	0,	BLK_UNIT(0x002f0000), BLK_UNIT(0x000C0000), BLK_UNIT(0x00000000)},
	[5] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x003B0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},	
	#elif 0//dsa data stored in Pstore when Ecos disabled
    [0] = {EMBTYPE_LOADER,	0,	BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [2] = {EMBTYPE_UITRON,	0,	BLK_UNIT(0x00020000), BLK_UNIT(0x002b0000), BLK_UNIT(0x00000000)},
    [3] = {EMBTYPE_UBOOT,	0,	BLK_UNIT(0x002d0000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
    [4] = {EMBTYPE_PSTORE,	0,	BLK_UNIT(0x00310000), BLK_UNIT(0x00090000), BLK_UNIT(0x00000000)},
    [5] = {EMBTYPE_DSP, 	0,	BLK_UNIT(0x003A0000), BLK_UNIT(0x00060000), BLK_UNIT(0x00000000)},
    #else //dsa data stored via User pack function when Pstore unused & Ecos enabled
    [0] = {EMBTYPE_LOADER,	0,	BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    ...
    //[4] = {EMBTYPE_PSTORE,	0,	BLK_UNIT(0x00310000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
    [4] = {EMBTYPE_DSP, 	0,	BLK_UNIT(0x003b0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)}, 
	//[5] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x003b0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},	
	[6] = {EMBTYPE_USER0,    0,  BLK_UNIT(0x003b0000), BLK_UNIT(0x00020000), BLK_UNIT(0x00000000)},
	[7] = {EMBTYPE_USER1,    0,  BLK_UNIT(0x003d0000), BLK_UNIT(0x00030000), BLK_UNIT(0x00000000)},
   	#endif
