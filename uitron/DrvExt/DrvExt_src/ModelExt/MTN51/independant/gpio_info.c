...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
	...
	{  GPIO_VOICE_DATA, 	   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_VOICE_DATA	  },
	{  GPIO_VOICE_RST,	   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_VOICE_RST	  },
	//amplifier
    ...
    {  GPIO_SENSOR_PWR2_8,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST		},
    {  GPIO_SENSOR_RESET,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST		},
	//sensor2 power
    {  GPIO_SENSOR2_1_2EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST		},	
    {  GPIO_SENSOR2_3_3EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST		},
    {  GPIO_SENSOR2_RESET,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST		},

    {  GPIO_SENSOR2_PWR5V,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST		},


//WIFI Module
	//{  GPIO_EDOG_CTL,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_EDOG_CTL		},
	{  GPIO_WIFI_SHDN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST		},
	{  GPIO_WIFI_EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST		},

	//LED
    {  GPIO_MOVIE_LED,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST		},
    {  GPIO_STATUS_LED,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST		},
