...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
...
#elif (defined(_SENSOR1_CMOS_GC2023M_) && defined(_SENSOR2_CMOS_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {
        PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC4653M_) && defined(_SENSOR2_CMOS_OFF_))
	{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_NONE},
	{
		PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC2023P_) && defined(_SENSOR2_CMOS_OFF_))
...
#elif (defined(_SENSOR1_CMOS_GC2053P_) && defined(_SENSOR2_CMOS_PR2020K_))
	{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_12BITS | PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_CCIR8BITS | PIN_SENSOR2_CFG_MCLK},
    {
		PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC2053P_) && defined(_SENSOR2_CMOS_AD_pr2020k_))
		{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_12BITS | PIN_SENSOR_CFG_MCLK},
		{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_CCIR8BITS | PIN_SENSOR2_CFG_MCLK},
		{
			PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_PR2020K_))
	{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_CCIR8BITS | PIN_SENSOR2_CFG_MCLK},
	{
		PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC4653M_) && defined(_SENSOR2_CMOS_PR2020K_))
	{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_CCIR8BITS | PIN_SENSOR2_CFG_MCLK},
	{
		PIN_FUNC_MIPI_LVDS,
	...
	PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_GC2023M_) && defined(_SENSOR2_CMOS_OFF_))
	PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_OFF_))
	PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_GC4653M_) && defined(_SENSOR2_CMOS_OFF_))
	PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_GC2023P_) && defined(_SENSOR2_CMOS_OFF_))
	PIN_I2C_CFG_CH1 |
#endif
...
#endif
#if (defined(_SENSOR1_CMOS_GC2053P_) && defined(_SENSOR2_CMOS_PR2020K_))
	PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH3 |
#endif
#if (defined(_SENSOR1_CMOS_GC2053P_) && defined(_SENSOR2_CMOS_AD_pr2020k_))
	PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH3 |
#endif
#if (defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_PR2020K_))
	PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH3 |
#endif
#if (defined(_SENSOR1_CMOS_GC4653M_) && defined(_SENSOR2_CMOS_PR2020K_))
	PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH3 |
#endif
	...
	//
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_NONE},//PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_THROUGH}, // for ILI9342C
