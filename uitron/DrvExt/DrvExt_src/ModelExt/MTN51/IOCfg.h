...
#define LCD_BACKLIGHT_CTRL          LCD_BACKLIGHT_DUMMY
...
#define TV_DET_CTRL                 TV_DET_DUMMY //FPGA
...
// CARD
// SD card power
#define GPIO_CARD_POWER             32//P_GPIO_11
#define PAD_CARD_POWER              32//PAD_PIN_PGPIO11
// SD card detect
...
#define GPIO_TP_DOUT                32//P_GPIO_8 //P_GPIO_58 //HW TP_DI  =SBDAT0/AGPIO-26   (FW output = HW input)
#define GPIO_TP_DIN                 (1 | GPIO_IS_DGPIO) //HW TS_DO  =DGPIO-01  (FW input = HW output)
#define GPIO_TP_DCLK                32//P_GPIO_7//P_GPIO_57 //HW TS_CLK =SBCK0/AGPIO-25
//#define GPIO_TP_CS                  28 //HW TS_CS  =SBCS1/AGPIO-28  //SIF channel 1
#define GPIO_TP_CS                  32//P_GPIO_6//P_GPIO_56 //HW TS_CS  =SBCS0/AGPIO-27  //SIF channel 0
...
*/
#define GPIO_GS_RST					L_GPIO_8//P_GPIO_10
...
#define GPIO_MOVIE_LED				P_GPIO_17
#define PAD_MOVIE_LED				PAD_PIN_PGPIO17
#define LED_STATUS_DUMMY				0
#define LED_STATUS_BY_GPIO			1
#define LED_STATUS_CTRL				LED_STATUS_BY_GPIO
#define GPIO_STATUS_LED				P_GPIO_22
#define PAD_STATUS_LED				PAD_PIN_PGPIO22
...
//VOICE
#define GPIO_VOICE_BUSY_DET			32//P_GPIO_11
#define PAD_VOICE_BUSY_DET			32//PAD_PIN_PGPIO11
#define GPIO_VOICE_DATA				32//P_GPIO_1
#define PAD_VOICE_DATA				32//PAD_PIN_PGPIO1
#define GPIO_VOICE_RST				32//P_GPIO_0
#define PAD_VOICE_RST				32//PAD_PIN_PGPIO0

//power amplifier module
#define GPIO_AMP_POWER		32//L_GPIO_20   //		P_GPIO_19
#define PAD_AMP_POWER		32//		PAD_PIN_LGPIO20

#define GPIO_AMP_SHDN		32//	L_GPIO_20  //	P_GPIO_25
#define PAD_AMP_SHDN		32//	PAD_PIN_LGPIO20 //	PAD_PIN_PGPIO25
...
// Wifi Module device
//--------------------------------------------------------------------
#define GPIO_WIFI_SHDN          L_GPIO_15//P_GPIO_2
#define GPIO_WIFI_EN            32//P_GPIO_8


//--------------------------------------------------------------------
// Sensor device
//--------------------------------------------------------------------
#define GPIO_SENSOR_PWR1_2          L_GPIO_19//P_GPIO_7
#define GPIO_SENSOR_PWR1_8          L_GPIO_10//P_GPIO_3
#define GPIO_SENSOR_PWR2_8          L_GPIO_9//P_GPIO_6
#define GPIO_SENSOR_RESET			S_GPIO_9


//sensor2
#define GPIO_SENSOR2_1_2EN			P_GPIO_19
#define GPIO_SENSOR2_3_3EN			P_GPIO_25
#define GPIO_SENSOR2_RESET   		P_GPIO_9

#define GPIO_SENSOR2_PWR5V   		L_GPIO_17
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_REG_ON			32//P_GPIO_4 // WiFi regulator on, high active
#define GPIO_WIFI_PWR_ON			32//P_GPIO_2 // WiFi power on, high active
...
#define GPIO_LENS_IR_CTRL0          0//P_GPIO_6       // output
#define GPIO_LENS_IR_CTRL1          0//P_GPIO_7       // output
#define PAD_LENS_IR_CTRL0           0//PAD_PIN_PGPIO6
#define PAD_LENS_IR_CTRL1           0//PAD_PIN_PGPIO7

//--------------------------------------------------------------------
// Speaker power control device
//--------------------------------------------------------------------
#define GPIO_SPK_PWR_CTRL           L_GPIO_14//P_GPIO_12
#define PAD_SPK_PWR_CTRL            PAD_PIN_LGPIO14//PAD_PIN_PGPIO12
