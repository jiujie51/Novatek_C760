...
static void sen_power_ctrl_imx307m(SENSOR_ID id, POW_CTRL_FLAG flag)
{
...
#elif 1//(defined(_NVT_ETHREARCAM_RX_))
 UINT32 reset_pin = S_GPIO_6;
    ...
    case POW_CTRL_TURN_ON:
        ...
        Delay_DelayMs(20);
#elif 1//(defined(_NVT_ETHREARCAM_RX_))
        gpio_setDir(P_GPIO_24, GPIO_DIR_OUTPUT);   //GPIO_SENSOR_3.3V_EN
...
static BOOL sen_det_plug_in_imx307m(SENSOR_ID id)
{
	return !gpio_getPin(GPIO_SENSOR2_PLUG_DET);
}
...
#endif
#if (defined(_CMOS_IMX307M_))
	{"CMOS_IMX307M", sensor_get_drv_tab_imx307m, sensor_get_obj_imx307m, sen_power_ctrl_imx307m, sen_det_plug_in_imx307m, NULL, NULL},
#endif
#if (defined(_CMOS_IMX307L_))
