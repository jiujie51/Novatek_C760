...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
...
#elif (defined(_SENSOR1_CMOS_IMX335M_) && defined(_SENSOR2_CMOS_IMX307M_))
        {PIN_FUNC_SENSOR,            PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
        {PIN_FUNC_SENSOR2,           PIN_SENSOR2_CFG_MIPI | PIN_SENSOR2_CFG_MCLK2},
        {
            PIN_FUNC_MIPI_LVDS,
...
#endif
#if (defined(_SENSOR1_CMOS_IMX335M_) && defined(_SENSOR2_CMOS_IMX307M_))
    PIN_I2C_CFG_CH2 | PIN_I2C_CFG_CH3 |
#endif
	...
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | 
        ...
        PINMUX_LCDMODE_RGB_PARALL565
#else
        PINMUX_LCDMODE_RGB_SERIAL
#endif
    },
