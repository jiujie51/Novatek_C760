...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
	...
	{  GPIO_SENSOR1_EN,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	}, // high active
	{  GPIO_671_POWER_EN,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	}, // high active
    {  GPIO_SENSOR2_PLUG_DET,       GPIO_DIR_INPUT,     PAD_PULLUP,             PAD_SENSOR2_PLUG_DET        }, // low detect
	{  GPIO_LCD_BLG_PCTL,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST	}, // high active
#if defined(_Disp_IFPA_LCD1_JL_0316IVO_ST7701S_)
    {  GPIO_LCD_PWR_1P8_EN,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   }, // high active
	{  GPIO_LCD_PWR_3P3_EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST	}, // high active
#endif
...
//	{  GPIO_LED,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST	}, // high active
	{  GPIO_SPEAK,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	}, // high active
	// VOICE
	...
	//amplifier
	{  GPIO_AMP_POWER,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST		},
