...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
	...
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00500000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00520000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00570000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00670000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,	0,	BLK_UNIT(0x00670000), BLK_UNIT(0x00190000), BLK_UNIT(0x00000000)},
	#endif
	#endif
	#else
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00140000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00160000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x001B0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	[5] = {EMBTYPE_ECOS,	0,	BLK_UNIT(0x001B0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)}, // For 2MB flash
	#endif
#elif defined(_EMBMEM_SPI_NAND_)
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00040000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
