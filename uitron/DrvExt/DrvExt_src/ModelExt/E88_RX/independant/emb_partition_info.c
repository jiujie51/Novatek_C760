...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
#if defined(_EMBMEM_SPI_NOR_)
#if 1//(SPI_4MB == ENABLE) //simon_h
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x002C0000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x002E0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00330000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[6] = {EMBTYPE_ECOS,	0,	BLK_UNIT(0x00380000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	...
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00570000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
