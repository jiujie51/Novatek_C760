...
/*
void IO_SetBlueLed(void)
{
    gpio_setPin(GPIO_BLUE_EN);//low active
}

void IO_ClearBlueLed(void)
{
    gpio_clearPin(GPIO_BLUE_EN);
}

UINT32 IO_GetBlueStatus(void)
{
    return gpio_getPin(GPIO_BLUE_EN);
}
*/
void IO_SetIRLed(void)//low active
{
    gpio_clearPin(GPIO_IR_EN);
}

void IO_ClearIRLed(void)
{
    gpio_setPin(GPIO_IR_EN);
}

UINT32 IO_GetIRStatus(void)
{
    return !(gpio_getPin(GPIO_IR_EN));
}
