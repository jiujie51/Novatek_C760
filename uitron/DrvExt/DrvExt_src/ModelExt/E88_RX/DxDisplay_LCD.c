...
#define LCD_MAX_W                       ALIGN_CEIL_16(1920)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
#elif defined(_Disp_IFPA_LCD1_LT8918_WTL096601G03_) //simon_h
#define LCD_MAX_W                       ALIGN_CEIL_16(320)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
{
	// Reset LCD
#if defined(_Disp_IF8B_LCD1_ILI9341_)||defined(_Disp_IF8B_LCD1_ILI9342C_)||defined(_Disp_IFPA_LCD1_T30P106_) ||defined(_Disp_IF8B_LCD1_S2002L11_ST7789S_)
	gpio_clearPin(GPIO_LCD_RESET);
	SwTimer_DelayMs(5);
	gpio_setPin(GPIO_LCD_RESET);
#elif defined(_Disp_IFDSI_LCD1_BPB5017BFW_ILI9806E_)||defined(_Disp_IFPA_LCD1_LT8918_WTL096601G03_)
	gpio_clearPin(GPIO_LCD_RESET);
	SwTimer_DelayMs(10);
	gpio_setPin(GPIO_LCD_RESET);
#endif
...
//		gpio_setPin(GPIO_LCD_BLG_PWR);
              Delay_DelayMs(1); 
		gpio_setPin(GPIO_BLG_PCTL);//simon_h
#else
		DrvLCD_TurnOn();
		DrvLCD_TurnOn_WaitFinish();
#endif
