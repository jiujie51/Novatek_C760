...
#define GPIO_LCD_RESET              L_GPIO_22//simon_h L_GPIO_20
#define GPIO_LCD_ENABLE              P_GPIO_25 //simon_h
#define GPIO_LCD_1P8_ENABLE              P_GPIO_10//P_GPIO_17 //simon_h
#define GPIO_GPS_ENABLE              C_GPIO_10 //simon_h
...
#define GPIO_LCD_BLG_PCTL		S_GPIO_14//	P_GPIO_7 //simon_h P_GPIO_25
#define PAD_LCD_BLG_PCTL		PAD_PIN_SGPIO12//	 PAD_PIN_PGPIO7 //simon_h PAD_PIN_PGPIO25
//#define GPIO_LCD_BLG_PWR          P_GPIO_25//C_GPIO_4//simon_h P_GPIO_0
//#define GPIO_LCD_BLG_PWR_PAD            PAD_PIN_PGPIO25//PAD_PIN_CGPIO4//simon_h PAD_PIN_PGPIO0

#define GPIO_BLG_PCTL          S_GPIO_14//P_GPIO_7//simon_h P_GPIO_0
#define GPIO_BLG_PCTL_PAD        PAD_PIN_SGPIO12// PAD_PIN_PGPIO7//simon_h PAD_PIN_PGPIO0
...
// CARD
// card power
#define GPIO_CARD_POWER             C_GPIO_14//C_GPIO_19
#define PAD_CARD_POWER              PAD_PIN_CGPIO14//PAD_PIN_CGPIO19
// SD card detect
...
#define GPIO_ETH_PWR_ENABLE            P_GPIO_24//P_GPIO_10
...
*/
#define GPIO_GS_RST					S_GPIO_6//P_GPIO_1
...
//#define GPIO_RED1_EN                D_GPIO_1
//#define PAD_RED1_EN                 PAD_PIN_DGPIO1
//#define GPIO_BLUE_EN                D_GPIO_0
//#define PAD_BLUE_EN                 PAD_PIN_DGPIO0

#define GPIO_IR_EN                  P_GPIO_0
#define PAD_IR_EN                   PAD_PIN_PGPIO0

extern void IO_SetBlueLed(void);
extern void IO_ClearBlueLed(void);
extern UINT32 IO_GetBlueStatus(void);
extern void IO_SetIRLed(void);
extern void IO_ClearIRLed(void);
extern UINT32 IO_GetIRStatus(void);

#define LED_MOVIE_DUMMY				0
#define LED_MOVIE_BY_GPIO			1
#define LED_MOVIE_CTRL				LED_MOVIE_BY_GPIO
#define GPIO_MOVIE_LED				S_GPIO_12//P_GPIO_3
#define PAD_MOVIE_LED				PAD_PIN_SGPIO12//PAD_PIN_PGPIO3
...
#define GPIO_AMP_POWER			S_GPIO_13//	P_GPIO_8
//#define PAD_AMP_POWER				PAD_PIN_PGPIO10

#define GPIO_AMP_SHDN				P_GPIO_8
...
#define GPIO_LED_RED					D_GPIO_7
#define GPIO_LED_RED_PAD				PAD_PIN_DGPIO7

#define GPIO_LED_BLUE                           D_GPIO_6
#define GPIO_LED_BLUE_PAD                   PAD_PIN_DGPIO6

#define GPIO_SPEAK					P_GPIO_19
#define GPIO_SPEAK_PAD                      PAD_PIN_PGPIO19

//AHD onoff
#define GPIO_AHD_CTL				S_GPIO_14
#define PAD_AHD_CTL 				PAD_PIN_SGPIO14
//--------------------------------------------------------------------
// Power device
//--------------------------------------------------------------------
//Battery
#define ADC_CH_VOLDET_BATTERY       ADC_CHANNEL_0//ADC_CHANNEL_3
...
#define GPIO_SENSOR_SIE            P_GPIO_3
#define GPIO_SENSOR_PWR1_2         S_GPIO_5//D_GPIO_0
#define GPIO_SENSOR_PWR3_3         S_GPIO_4//D_GPIO_1
#define GPIO_SENSOR_PWR1_8         P_GPIO_9
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_REG_ON			P_GPIO_23 // WiFi regulator on, high active
#define GPIO_WIFI_PWR_ON		C_GPIO_7//	P_GPIO_24//P_GPIO_23//siom_h P_GPIO_1 // WiFi power on, high active
//--------------------------------------------------------------------
// Speaker power control device
//--------------------------------------------------------------------
#define GPIO_SPK_PWR_CTRL           S_GPIO_13//S_GPIO_12//P_GPIO_12
#define PAD_SPK_PWR_CTRL            PAD_PIN_SGPIO13//PAD_PIN_SGPIO12//PAD_PIN_PGPIO12
