...
UINT32 DrvCARDInit(void *pInitParam) // Set Init Parameters
{
	...
	*/
	...
	sdio_setConfig(SDIO_CONFIG_ID_DS_DRIVING, 100);
	sdio_setConfig(SDIO_CONFIG_ID_DS_CMD_DRIVING, 50);
	sdio_setConfig(SDIO_CONFIG_ID_DS_DATA_DRIVING, 50);

	// High speed driving
	sdio_setConfig(SDIO_CONFIG_ID_HS_DRIVING, 100);
	sdio_setConfig(SDIO_CONFIG_ID_HS_CMD_DRIVING, 50);
	sdio_setConfig(SDIO_CONFIG_ID_HS_DATA_DRIVING, 50);
#else
