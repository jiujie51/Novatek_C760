...
//simon_h	{DRVSOUND_VOUT_LCD, AUDIO_CH_LEFT, FALSE},
	{DRVSOUND_VOUT_LCD, AUDIO_CH_STEREO, FALSE},
...
#else
UINT32 gCurDrvSndVol = 100; //simon_h
AUDIO_GAIN gCurDrvSndGain = AUDIO_GAIN_15;//simon_h
#endif
...
//CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;CHKPNT;
...
//OS_DumpCurrentBacktrace();
//DBG_DUMP("gCurDrvSndVol=%d, vol= %d\r\n",gCurDrvSndVol,vol);
...
//	aud_setDefaultSettings(AUDIO_DEFSET_30DB);
    aud_setParameter(AUDIO_PARAMETER_DAGAIN,AUDIO_DAGAIN_P18DB);//simon_h AUDIO_DAGAIN_P18DB);
#endif
