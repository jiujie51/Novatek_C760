...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
...
#if 1
	/*[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00050000), BLK_UNIT(0x00900000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00950000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x009D0000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00A40000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00A40000), BLK_UNIT(0x00160000), BLK_UNIT(0x00000000)},
	#endif
	#else
	...
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00050000), BLK_UNIT(0x00250000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x002A0000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00320000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00390000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00390000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	#endif
	#else
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00E00000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
