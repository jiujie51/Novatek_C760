...
#else
#define LCD_COMM_CTRL 				LCD_COMM_BY_SIF//LCD_COMM_BY_GPIO
#endif
...
#define LCD_BACKLIGHT_CTRL          LCD_BACKLIGHT_BY_GPIO//LCD_BACKLIGHT_BY_PWM //FPGA
#if (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)
#define GPIO_PWM_LCD_BLG_PCTL       P_GPIO_0
#define PWMID_LCD_BLG_PCTL          PWMID_0
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL           S_GPIO_14//GPIO_BL_PWR//P_GPIO_0
...
#define GPIO_MOVIE_LED                S_GPIO_12 
...
#define GPIO_ETH_PWR              P_GPIO_24//P_GPIO_7


//LCD BACKLIGHT
#define GPIO_BL_PWR               P_GPIO_1
#define GPIO_LCD_RESET             L_GPIO_20//L_GPIO_22

//LCD Driver
#define GPIO_VSP_VSN_EN           P_GPIO_19
#define GPIO_VGL_VGH_EN           P_GPIO_6
...
#define ADC_CH_VOLDET_BATTERY_MT    ADC_CHANNEL_0
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_PWR_ON            C_GPIO_7// WiFi power on, high active
#define GPIO_WIFI_CS				S_GPIO_3
//--------------------------------------------------------------------
...
// gsensor
//--------------------------------------------------------------------
#define GPIO_GS_RST                 S_GPIO_6

//--------------------------------------------------------------------
// GPS
//--------------------------------------------------------------------
#define GPIO_GPS_EN                 P_GPIO_17
