...
#define LCD_MAX_H                       ALIGN_CEIL_16(384)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
static void GPIOMap_TurnOnLCDBacklight(void)
{
	...
	if (g_LCDBacklightEn == FALSE) {
		...
		pwm_pwmConfigClockDiv(PWM0_3_CLKDIV,1999);
