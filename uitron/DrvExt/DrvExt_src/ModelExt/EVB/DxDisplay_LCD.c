...
static UINT32 DrvLCDOpen(void) // Common Constructor
{
	...
	//IVOT_SQA_N00004-1001
	#if (LCD_BACKLIGHT_CTRL != LCD_BACKLIGHT_BY_PWM && LCD_BACKLIGHT_CTRL != LCD_BACKLIGHT_BY_GPIO)
...
#else
		//mark for speedup poweron
		//upmark for IVOT_SQA_N00004-1001
		DrvLCD_TurnOn();
		DrvLCD_TurnOn_WaitFinish();
