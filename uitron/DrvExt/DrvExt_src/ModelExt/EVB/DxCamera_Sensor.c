...
#if (defined(_CMOS_F37P_))
#if 0
static void csi_hw_rst_f37p(SENSOR_ID sensor_id)
{
...
#endif
static SENSOR_INIT_OBJ sensor_get_obj_f37p(SENSOR_ID id)
{
	// set sensor command interface info (Vx1/SIF/I2C/IO/...)
	SENSOR_INIT_OBJ init_obj = {0};
	init_obj.cmd_info.cmd_type = SENSOR_CMD_I2C;
...
static void sen_power_ctrl_f37p(SENSOR_ID id, POW_CTRL_FLAG flag)
{
	UINT32 reset_pin = S_GPIO_4;
...
#if (defined(_CMOS_F37M_))
static SENSOR_INIT_OBJ sensor_get_obj_f37m(SENSOR_ID id)
{
    // set sensor command interface info (Vx1/SIF/I2C/IO/...)
    SENSOR_INIT_OBJ init_obj = {0};
    init_obj.cmd_info.cmd_type = SENSOR_CMD_I2C;
...
static void sen_power_ctrl_f37m(SENSOR_ID id, POW_CTRL_FLAG flag)
{
    UINT32 reset_pin = S_GPIO_4;
    UINT32 pwdn_pin = S_GPIO_9;
    switch (flag) {
...
#endif
#if (defined(_CMOS_F37P_))
	{"CMOS_F37P", sensor_get_drv_tab_f37p, sensor_get_obj_f37p, sen_power_ctrl_f37p, NULL, NULL, NULL},
#endif
#if (defined(_CMOS_F37M_))
	{"CMOS_F37M", sensor_get_drv_tab_f37m, sensor_get_obj_f37m, sen_power_ctrl_f37m, NULL, NULL, NULL},
#endif
