...
#define GPIO_LCD_RESET              L_GPIO_22
...
#define GPIO_LCD_BLG_PCTL           L_GPIO_23
#define PAD_LCD_BLG_PCTL            PAD_PIN_LGPIO23
#endif
...
#define GPIO_WIFI_PWR_ON			P_GPIO_12 // WiFi power on, high active
