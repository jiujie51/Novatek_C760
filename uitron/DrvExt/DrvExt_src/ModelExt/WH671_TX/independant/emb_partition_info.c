...
//	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00360000), BLK_UNIT(0x000A0000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x004E0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
   	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00370000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	[6] = {EMBTYPE_ECOS,	0,	BLK_UNIT(0x004E0000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
