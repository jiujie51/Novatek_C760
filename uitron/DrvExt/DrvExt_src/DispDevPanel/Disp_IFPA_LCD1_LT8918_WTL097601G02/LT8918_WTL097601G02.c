...
const tLCD_PARAM tModeParal[] = {
	/***********       RGB16 DA MODE         *************/
	{
		// tPANEL_PARAM
		{
			...
			0x03,                           //!< uiHSyncSYNCwidth
			0x03                            //!< uiVSyncSYNCwidth
		},
...
ER LT8918_Init(void)
{
	...
	g_pI2cObj = i2c_getDrvObject(I2C_ID_I2C); // 1st I2C
...
static ER LT8918_SetRegBank(UINT32 bank)
{
...
static void LT8918_DesscPll_Init(void)
{
	...
	LT8918_WriteReg(0xaa, 0xB8);
	LT8918_WriteReg(0xab, 0x51);
	LT8918_WriteReg(0xac, 0xEB);
...
static void LT8918_TxPll_Output_Config(void)
{
	...
	//LT8918_WriteReg(0x33, 0x24); //tx pll
	LT8918_WriteReg(0x33, 0x27); //tx pll
	LT8918_WriteReg(0x34, 0x02);
	LT8918_WriteReg(0x24, 0x44);
...
static void LT8918_TxPrtcl_Config(void)
{
	...
	LT8918_WriteReg(0x12, 0x00); //rd_dly[15:8]
	LT8918_WriteReg(0x13, 0x8C); //rd_dly[7:0]FIFO(byte_clk)
	LT8918_WriteReg(0x16, g_VidTiming.vact/256); //vact[15:8]
	LT8918_WriteReg(0x17, g_VidTiming.vact%256); //vact[7:0]--1920
	LT8918_WriteReg(0x19, 0x0F);
	LT8918_WriteReg(0x1a, 0x0F);
	LT8918_WriteReg(0x1b, 0x0F);
...
static void vdLT8918L_TxPll_Output_Config(void)
{
	...
	LT8918_ReadReg(0x32, &data);
	fm_value = fm_value + data;	
	DBG_DUMP("vdLT8918L_TxPll_Output_Config, MIPI Byte clock: %d\r\n", fm_value);
}
...
static  void vdLT8918L_TxPrtcl_Config(void)
{
	...
	LT8918_WriteReg(0x13,0x20);  //rd_dly[7:0]FIFO(byte_clk)
	LT8918_WriteReg(0x16,(UINT8)(g_VidTiming.vact/256)); //vact[15:8]
	LT8918_WriteReg(0x17,(UINT8)(g_VidTiming.vact%256)); //vact[7:0]--1920
	LT8918_WriteReg(0x19,0x0F);
	LT8918_WriteReg(0x1a,0x0F);
	LT8918_WriteReg(0x1b,0x0F);
	LT8918_WriteReg(0x1c,(UINT8)(g_VidTiming.hact/256));  //Hactive[15:8]
	LT8918_WriteReg(0x1d,(UINT8)(g_VidTiming.hact%256));  //Hactive[7:0]--1200	
	//LT8918_WriteReg(0x10,0x18);
	//LT8918_WriteReg(0x1f,0x00);
	//LT8918_WriteReg(0x11,0x0c);
	LT8918_WriteReg(0x10, 0x00);
	...
	LT8918_WriteReg(0x14,(UINT8)(g_VidTiming.vs%256));  //vsa--2
	LT8918_WriteReg(0x15,(UINT8)(g_VidTiming.vbp%256)); //vbp--8
	LT8918_WriteReg(0x18,(UINT8)(g_VidTiming.vfp%256)); //vfp--08
