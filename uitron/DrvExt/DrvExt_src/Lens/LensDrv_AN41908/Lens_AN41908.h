...
#define LENS_DRV_ID                 "nvt-ver1.01"     // *
...
#define ZOOM_PSUM_DELAY             31       // * unit: msec (12*AN41908_PULSE2_STEP_CYCLE/27MHz)*255=28 msec
#else
...
typedef struct
{
    ...
    //T_IRCUT_CONTROL_2C         R2C;// 24

    T_AN41908_REG REG[25];
} AN41908_REGISTER;
