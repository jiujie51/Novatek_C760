...
extern UINT32 _SECTION(".kercfg_data") g_uiLv8044SpiSema;
...
static LENSMOTOR_INFO g_LensMotorInfo =
{
    ...
    .LensMotorConfig[1].eMoveSpeed      = LV8044_MOTOR_SPD_2X,         // *
    .LensMotorConfig[1].uiPwmBaseNum    = 30,                          // *
    ...
    .ZoomFocusTbl[2]  = {  52,         162,   282 },         // * 2
    .ZoomFocusTbl[3]  = { 100,         334,   454 },         // * 3
    .ZoomFocusTbl[4]  = { 160,         512,   652 },         // * 4
    .ZoomFocusTbl[5]  = { 220,         656,   776 },         // * 5
    .ZoomFocusTbl[6]  = { 292,         798,   918 },         // * 6
    .ZoomFocusTbl[7]  = { 360,         900,  1020 },         // * 7
    .ZoomFocusTbl[8]  = { 440,         988,  1108 },         // * 8
    .ZoomFocusTbl[9]  = { 528,        1074,  1194 },         // * 9
    .ZoomFocusTbl[10] = { 612,        1127,  1247 },         // * 10
    .ZoomFocusTbl[11] = { TELE_BOUND, 1159,  INF_BOUND },    // * 11
