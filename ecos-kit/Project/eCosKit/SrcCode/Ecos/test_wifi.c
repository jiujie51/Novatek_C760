...
#if defined(_NVT_SDIO_WIFI_RTK_) && defined(_NETWORK_CPU2_)
#include <network.h>
...
static void init_wifi_settings(char *mode, char *security)
{
    ...
    if (strcmp(pwifi->mode, mode) != 0) {
        ...
        wifi_settings_sample.is_configured = 0;
    }
...
static int configure_wifi_sample(struct wifi_settings_sample *pwifi)
{
    ...
    */
    ...
    //wscd.conf
    strcpy(pcfg->device_name, "Realtek Wireless AP");
...
void sample_sys_main(cyg_addrword_t data)
{
    ...
    if (strcmp(wifi_settings_sample.mode, "ap") == 0) {
        ...
        interface_config("wlan0", "192.168.1.89", "255.255.255.0");
        //interface_config2("wlan0", "192.168.1.89", "255.255.255.0");
    }
