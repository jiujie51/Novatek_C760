...
#if defined(__UITRON)
#define __LIB_SSENDER_USE_FAKE_IPC  1
#else
#define __LIB_SSENDER_USE_FAKE_IPC  0
#endif

#if defined(__LINUX)
#define __LIB_SSENDER_USE_FAKE_IOCTL    0
#else
#define __LIB_SSENDER_USE_FAKE_IOCTL    1
#endif
...
#if __LIB_SSENDER_USE_FAKE_IOCTL
extern int ssender_fakeio_module_init(void);
extern int ssender_fakeio_module_exit(void);
extern int ssender_fakeio_open(void);
extern int ssender_fakeio_ioctl(int hdl, int req_id, void *argp);
extern int ssender_fakeio_close(int hdl);
#endif
