 ...
 * =================================================================
 */
#define HFS_INTERFACE_VER 0x20042017
...
typedef int  cyg_hfs_upload_result_cb(int result, HFS_U32 bufAddr, HFS_U32* bufSize, char* mimeType, HFS_U32 segmentCount);///< Callback function for upload command complete
